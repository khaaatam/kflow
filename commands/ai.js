...
const observe = async (client, msg, namaPengirim) => {
    ...
    // Kalau pesan mengandung "Generated by Tami", berarti ini output bot sendiri -> SKIP
    ...
    try {
        ...
        // Cek Respon AI
        if (fact.toUpperCase().includes('SKIP')) {
            return;
        }
        ...
        // Lapor ke Owner (Hanya jika bukan pesan dari owner sendiri/bot, biar gak spam)
...
// ============================================================
// 👇 Penting: Parameter 'client' harus ada di paling depan biar sinkron sama handler
const interact = async (client, msg, args, senderId, namaPengirim, text) => {
    ...
    if (command === '!ai' || command === '!analisa' || command === '!tanya') {
        ...
        // Cek Media (Gambar Langsung atau Reply Gambar)
        const hasMedia = msg.hasMedia;
        const hasQuotedMedia = msg.hasQuotedMsg && (await msg.getQuotedMessage()).hasMedia;

        // Validasi: Kalau gak ada teks DAN gak ada media, tolak.
        if (!content && !hasMedia && !hasQuotedMedia) {
            return msg.reply("Mau nanya apa? Ketik: `!ai pertanyaanmu` atau kirim gambar.");
        }
        ...
        try {
            ...
            // Auto Prompt untuk Vision AI jika caption kosong
            ...
            // 👇 TEMPEL TANDA TANGAN BIAR OBSERVER TAU INI BOT
            reply += `\n\n${botSignature}`;
